...
print("predicted price of 1,10,100,1000 pages book => ",y_selected_pred) #결과.

'''
책의 페이지 수 와 가격은 linearRegrassion에 의해 전체적으로 상승하는 경향을 보이나. score점수나, mean_absolute_err를 통해 정확학 예측은 힘들다는 것을 알 수 있다.
'''
